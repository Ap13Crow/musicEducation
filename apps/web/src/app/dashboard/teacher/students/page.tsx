    ...
    <RoleGate allow={['TEACHER', 'ADMIN']} callbackUrl="/dashboard/teacher/students">
      <main className="mx-auto max-w-4xl px-6 py-10">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Everyone who has booked a lesson with you, across every instrument - the roster your one-off "Booked sessions"
          list on the workspace page doesn&rsquo;t group by student.
        </p>
