...
export default function ContentStudio(){
 ...
 return <RoleGate allow={['TEACHER','ADMIN']} callbackUrl="/dashboard/teacher/content"><main className="mx-auto max-w-6xl px-6 py-10">
  <Link href="/dashboard/teacher" className="text-sm text-primary-700">← Teacher workspace</Link><h1 className="mt-4 font-serif text-3xl font-bold">Pillar studio</h1><p className="mt-2 text-gray-600">Create native learning and performance content. External engines remain optional.</p>
